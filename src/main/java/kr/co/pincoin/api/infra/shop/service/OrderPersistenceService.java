...
public class OrderPersistenceService {
     ...
     */
    public Page<Order>
    searchUserOrders(Integer userId, OrderSearchCondition condition, Pageable pageable) {
        return searchOrders(
    ...
    public Order
    findUserOrder(Integer userId, String orderNo) {
    ...
    public Profile
    findUserProfile(User user) {
        return profileRepository.findByUserWithFetch(user)
     ...
     */
    public Page<Order>
    searchOrders(OrderSearchCondition condition, Pageable pageable) {
    ...
    @Transactional
    public void
    saveOrderProducts(List<OrderProduct> orderProducts) {
        orderProductRepository.saveAll(orderProducts);
    }

    @Transactional
    public OrderPayment
    savePayment(OrderPayment payment) {
        return orderPaymentRepository.save(payment);
    }

    @Transactional
    public void
    saveOrderProductVouchers(List<OrderProductVoucher> vouchers) {
    ...
    @Transactional
    public void
    softDeleteUserOrder(Order order) {
        order.softDelete();
        save(order);
    }
