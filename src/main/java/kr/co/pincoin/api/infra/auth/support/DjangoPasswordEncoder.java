...
public class DjangoPasswordEncoder implements PasswordEncoder {
  ...
  public String encrypt(String plain, String salt, int iterations)
  ...
  public String encode(String plain, String salt, int iterations)
      throws NoSuchAlgorithmException, InvalidKeySpecException {
  ...
  public boolean matches(CharSequence rawPassword, String encodedPassword) {
    ...
    try {
      return encode(rawPassword.toString(), parts[2], Integer.parseInt(parts[1]))
