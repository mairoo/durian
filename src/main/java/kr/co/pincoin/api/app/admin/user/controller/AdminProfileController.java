...
public class AdminProfileController {
    ...
    public ResponseEntity<ApiResponse<AdminUserResponse>> createUser(
        ...
        Profile profile = adminProfileService.createUser(
                request.getEmail(),
                request.getPassword(),
                request.getUsername(),
        ...
        return ResponseEntity.ok()
                .body(ApiResponse.of(AdminUserResponse.from(profile)));
    }

    @PostMapping("/admin")
    public ResponseEntity<ApiResponse<AdminUserResponse>> createAdmin(
            @Valid @RequestBody UserCreateRequest request) {
        Profile profile = adminProfileService.createAdmin(
                request.getEmail(),
                request.getPassword(),
                request.getUsername(),
                request.getFirstName(),
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<ApiResponse<AdminUserResponse>> getProfile(
