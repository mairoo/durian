...
public class BannedEmailSearchCondition {
    ...
    @Builder  // 메서드 이름을 명확히
    private BannedEmailSearchCondition(Boolean isRemoved,
                                       String emailPattern,
    ...
    public static BannedEmailSearchCondition ofPattern(String emailPattern) {
        return BannedEmailSearchCondition.builder()
                .emailPattern(emailPattern)
                .build();
    }

    public static BannedEmailSearchCondition ofPeriod(LocalDateTime startDate,
                                                      LocalDateTime endDate) {
        return BannedEmailSearchCondition.builder()
                .startDate(startDate)
                .endDate(endDate)
