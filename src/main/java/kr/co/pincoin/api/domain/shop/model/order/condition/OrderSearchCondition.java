...
public class OrderSearchCondition {
  ...
  public static OrderSearchCondition ofUserId(Integer userId) {
    return OrderSearchCondition.builder().userId(userId).build();
  }

  public static OrderSearchCondition ofOrderNo(String orderNo) {
    return OrderSearchCondition.builder().orderNo(orderNo).build();
  }

  public static OrderSearchCondition ofUser(
      String fullname, String phone, String email, String username) {
  ...
  public static OrderSearchCondition ofPeriod(LocalDateTime startDate, LocalDateTime endDate) {
    return OrderSearchCondition.builder().startDate(startDate).endDate(endDate).build();
  }

  public static OrderSearchCondition ofStatus(OrderStatus status) {
    return OrderSearchCondition.builder().status(status).build();
  }
