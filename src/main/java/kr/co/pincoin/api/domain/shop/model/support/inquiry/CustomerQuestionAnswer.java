...
public class CustomerQuestionAnswer {
  ...
  @Builder
  private CustomerQuestionAnswer(
      Long id,
      String content,
  ...
  public static CustomerQuestionAnswer of(String content, CustomerQuestion question) {
    return CustomerQuestionAnswer.builder().content(content).question(question).build();
  }
  ...
  public boolean isFirstAnswer() {
    return this.question != null && this.question.getAnswerCount() == 0;
  }
  ...
  public boolean equals(Object o) {
    ...
    return created.equals(that.created) && question.getId().equals(that.question.getId());
  }
