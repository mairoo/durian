...
public class TestimonialAnswer {
  ...
  public static TestimonialAnswer of(String content, Testimonial testimonial) {
    return TestimonialAnswer.builder().content(content).testimonial(testimonial).build();
  }
  ...
  public boolean isFirstAnswer() {
    return this.testimonial != null && this.testimonial.getAnswerCount() == 0;
  }

  public boolean belongsToTestimonial(Long testimonialId) {
    return this.testimonial != null && this.testimonial.getId().equals(testimonialId);
  }
  ...
  public boolean isByStore() {
    return this.testimonial != null && this.testimonial.getStore() != null;
  }
  ...
  public boolean equals(Object o) {
    ...
    return created.equals(that.created) && testimonial.getId().equals(that.testimonial.getId());
  }
