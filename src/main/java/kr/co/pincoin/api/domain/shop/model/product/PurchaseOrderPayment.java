...
public class PurchaseOrderPayment {
  ...
  public static PurchaseOrderPayment of(Integer account, BigDecimal amount, PurchaseOrder order) {
    return PurchaseOrderPayment.builder().account(account).amount(amount).order(order).build();
  }
