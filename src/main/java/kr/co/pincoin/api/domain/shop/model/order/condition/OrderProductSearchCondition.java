...
public class OrderProductSearchCondition {
  ...
  @Builder
  private OrderProductSearchCondition(Long orderId, String orderNo, Integer userId) {
  ...
  public static OrderProductSearchCondition ofOrderId(Long orderId) {
    return OrderProductSearchCondition.builder().orderId(orderId).build();
  }

  public static OrderProductSearchCondition ofOrderNo(String orderNo) {
    return OrderProductSearchCondition.builder().orderNo(orderNo).build();
  }

  public static OrderProductSearchCondition ofUserId(Integer userId) {
    return OrderProductSearchCondition.builder().userId(userId).build();
  }
