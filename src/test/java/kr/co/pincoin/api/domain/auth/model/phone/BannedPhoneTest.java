...
class BannedPhoneTest {
  ...
  void softDeleteAndRestore() {
    // Given
    BannedPhone bannedPhone = BannedPhone.builder().phone("01012345678").isRemoved(false).build();
  ...
  void removedPhoneShouldNotMatch() {
    // Given
    BannedPhone bannedPhone = BannedPhone.builder().phone("01012345678").isRemoved(true).build();
