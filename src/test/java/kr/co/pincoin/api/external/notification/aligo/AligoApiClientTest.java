...
@SpringBootTest(classes = {WebClientConfig.class, AligoApiClient.class, ObjectMapper.class})
@ActiveProfiles("test")
class AligoApiClientTest {

  @Autowired private AligoApiClient aligoApiClient;

  @Test
  void sendSms() {
    // Given
    AligoSmsRequest request =
        AligoSmsRequest.builder()
